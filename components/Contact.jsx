...
export default function Contact() {
  ...
  const handleWhatsAppClick = () => {
    // Replace with your actual WhatsApp number (include country code, remove any leading zeros)
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      title: "Live Chat",
      content: "Available Monday-Friday, 9AM-5PM EST",
      action: (
        <button
          onClick={handleWhatsAppClick}
          className="mt-2 bg-green-500 hover:bg-green-600 text-white font-medium py-2 px-4 rounded-lg flex items-center justify-center"
        >
    ...
    <section id="contact" className="py-20 bg-blue-800 text-white">
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-1/2">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-yellow-400 hover:bg-yellow-500 text-blue-900 font-bold py-3 px-6 rounded-lg transition-colors disabled:opacity-70"
              >
          ...
          {/* Contact Info */}
          <div className="lg:w-1/2 bg-blue-900 bg-opacity-50 p-8 rounded-xl">
