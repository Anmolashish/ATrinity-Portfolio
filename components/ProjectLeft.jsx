...
export default function ProjectLeft(props) {
  ...
  return (
    <div className="max-w-[1222px] w-[90%] border rounded-[40px] min-h-[200px] md:min-h-[324px] grid grid-cols-[min(50%,475px)_1fr] p-[20px]">
      ...
      <div className="pl-6 flex flex-col justify-between">
        ...
        <div className="flex gap-4 mt-2">
          <Link
            ...
            className={`bg-[#2A66FF] w-[50%] p-4 rounded-[21px] border-[#2A66FF] max-md:text-xs border-2 text-white text-center transition-all duration-300 ${
              props.demoUrl
          ...
          <Link
            ...
            className={`bg-white w-[50%] p-4 rounded-[21px] border-[#2A66FF] border-2 max-md:text-xs text-[#2A66FF] text-center transition-all duration-300 ${
