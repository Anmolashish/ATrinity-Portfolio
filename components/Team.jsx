  ...
  const teamMembers = [
    {
      ...
      bio: "Specializes in creating beautiful, responsive interfaces with attention to detail.",
    ...
    },
    {
      ...
      bio: "Builds robust server-side solutions and efficient databases.",
    ...
    },
    {
      ...
      bio: "Creates intuitive user experiences with pixel-perfect designs.",
    ...
    },
    {
      ...
      bio: "Optimizes websites to rank higher and attract more organic traffic.",
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            We're a group of college friends who turned our classroom skills
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {teamMembers.map((member, index) => (
            <div
              key={member.name}
              className="bg-gray-50 rounded-xl overflow-hidden text-center p-6 hover:shadow-md transition-shadow hover:-translate-y-1 duration-300"
              data-aos="fade-up"
        ...
        <div className="bg-blue-50 rounded-xl p-8 text-center">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto mb-6">
            This is where it all began - late night coding sessions, group
            projects, and endless cups of coffee.
          </p>
          <div className="rounded-xl overflow-hidden shadow-lg max-w-4xl mx-auto">
            <img
              src="/images/team/group-photo.jpg"
              alt="Our team in college"
